...
export class Backend implements backendInterface {
    ...
    async editNote(arg0: bigint, arg1: string): Promise<Note> {
        if (this.processError) {
            try {
                const result = await this.actor.editNote(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getNextNotification(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getNextNotification();
    ...
    async processNotifications(): Promise<Time> {
        if (this.processError) {
            try {
                const result = await this.actor.processNotifications();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setBreakReminder(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setBreakReminder(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
